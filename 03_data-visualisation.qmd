...
```
Ggplot has now established that those are the two variables you wish to create your visualisation around, and has added axis' that reflect the underlying distribution of these variables. 
