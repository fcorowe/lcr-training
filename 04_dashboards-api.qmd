...
search <- nomis_search("*Population*")
```
...
![How to insert code](figs/04/code-example.png) Then, once you have the read the data in you can produce one of the visualisations we made yesterday - such as the scatter plot we made yesterday:
...
### Independent exericse - Over to you!!

Have a good at embedding some more visualisations on the dashboard. To do this you will need to reproduce lots of the analysis you did on Day 2.
